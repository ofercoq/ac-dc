...
cdn_prox:
	...
	$(CC) $(OBJFOLDER)linpack.o $(OBJFOLDER)blas.o $(OBJFOLDER)timer.o $(OBJFOLDER)lbfgsb.o $(OBJFOLDER)cdn_prox.o -fopenmp -m64 $(LIBS) -o $(BUILD_FOLDER)cdn_prox 
	./$(BUILD_FOLDER)cdn_prox  -A data/a1a  -R 0
